...
foreach ($SMSMember in $SMSMemebers) {
    Invoke-WMIMethod -ComputerName $SMSMember -Namespace root\ccm -Class SMS_CLIENT -Name TriggerSchedule "{00000000-0000-0000-0000-000000000021}" -Verbose
    Invoke-WMIMethod -ComputerName $SMSMember -Namespace root\ccm -Class SMS_CLIENT -Name TriggerSchedule "{00000000-0000-0000-0000-000000000022}" -Verbose
}